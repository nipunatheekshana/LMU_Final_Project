console.log('createCompanyUsers.js is loading')
...
function loadCompany() {
    $.ajax({
        type: 'GET',
        url: '/settings/createCompanyUsers/loadCompany',
        async: false,
...
function save(data) {
    $.ajax({
        type: "POST",
        url: "/settings/createCompanyUsers/save",
        data: data,
        headers: {
...
function update(data) {
    $.ajax({
        type: "POST",
        url: "/settings/createCompanyUsers/update",
        data: data,
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
...
function loadUsers() {
    $.ajax({
        type: 'GET',
        url: '/settings/createCompanyUsers/loadUsers',
        success: function (response) {
            console.log(response.result)
            if (response.success) {
...
function loadUser(id) {
    $.ajax({
        type: 'GET',
        url: '/settings/createCompanyUsers/loadUser/' + id,
        success: function (response) {
            console.log(response.result)
            if (response.success) {
...
function _delete(id) {
    $.ajax({
        ...
        url: '/settings/createCompanyUsers/delete/' + id,
        success: function (response) {
            console.log(response);
