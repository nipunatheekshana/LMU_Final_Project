console.log('seaFoodProductConfigure .js loadimng');
var parent_url = '/sf/seaFoodProduct_list'
$(document).ready(function () {


    $('#btnSave').on('click', function () {
        var form = $('#frmseaFoodProductConfigure ').get(0);
...
function save(data) {
    $.ajax({
        type: "POST",
        url: "/sf/seaFoodProductConfigure/save",
        data: data,
        headers: {
        ...
        success: function (response) {
            ...
            if (response.success) {
                ...
                $('#frmseaFoodProductConfigure ').trigger("reset");
...
function update(data) {
    $.ajax({
        type: "POST",
        url: "/sf/seaFoodProductConfigure/update",
        data: data,
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
...
function loadseaFoodProduct() {
    ...
    if (id) {
        $.ajax({
            type: "GET",
            url: "/sf/seaFoodProductConfigure/loadseaFoodProduct/" + id,
            processData: false,
            contentType: false,
            cache: false,
            timeout: 800000,
...
function loadFishSpecis() {
    $.ajax({
        type: 'GET',
        url: '/sf/seaFoodProductConfigure/loadFishSpecis',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
...
function loadReceivePresentation() {
    $.ajax({
        type: 'GET',
        url: '/sf/seaFoodProductConfigure/loadReceivePresentation',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
                ...
                $('#ReceivePresentation').append(html);
...
function loadReceiveGrade() {
    $.ajax({
        type: 'GET',
        url: '/sf/seaFoodProductConfigure/loadReceiveGrade',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
...
function loaditemGoup() {
    $.ajax({
        type: 'GET',
        url: '/sf/seaFoodProductConfigure/loaditemGoup',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
...
function loaduom() {
    $.ajax({
        type: 'GET',
        url: '/sf/seaFoodProductConfigure/loaduom',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
