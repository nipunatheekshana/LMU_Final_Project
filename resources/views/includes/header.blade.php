            ...
            <div class="header-body-left">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown d-none d-md-block">
                        <a href="#" class="nav-link" title="Apps" data-toggle="dropdown">{{__('Shortcuts')}}</a>
                        <div class="dropdown-menu dropdown-menu-big">
                            <div class="border-bottom px-4 py-3 text-center d-flex justify-content-between">
                                <h5 class="mb-0">{{__('Shortcuts')}}</h5>
                            </div>
                            <div class="p-3">
                                <div class="row row-xs">
                                    <div class="col-4">
                                        <a href="/buying/grnHistory_list">
                                            <div class="border-radius-1 text-center mb-3">
                                                <figure class="avatar border-0">
                                                    <span class="avatar-title bg-primary text-white rounded-circle">
                                                        <i class="width-20 height-20" data-feather="truck"></i>
                                                    </span>
                                                </figure>
                                                <div class="mt-2">{{__('GRN History')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="/hrm/employee_list">
                                            <div class="border-radius-1 text-center mb-3">
                                                <figure class="avatar border-0">
                                                    <span class="avatar-title bg-secondary text-white rounded-circle">
                                                        <i class="width-20 height-20" data-feather="mail"></i>
                                                    </span>
                                                </figure>
                                                <div class="mt-2">{{__('Employees')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="/selling/customerOrder_list">
                                            <div class="border-radius-1 text-center">
                                                <figure class="avatar border-0">
                                                    <span class="avatar-title bg-info text-white rounded-circle">
                                                        <i class="width-20 height-20" data-feather="shopping-bag"></i>
                                                    </span>
                                                </figure>
                                                <div class="mt-2">{{__('Customer Order')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="/mnu/planingDetail_configure">
                                            <div class="border-radius-1 text-center">
                                                <figure class="avatar border-0">
                                                    <span class="avatar-title bg-warning text-white rounded-circle">
                                                        <i class="width-20 height-20" data-feather="grid"></i>
                                                    </span>
                                                </figure>
                                                <div class="mt-2">{{__('Planning Details')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#">
                                            <div class="border-radius-1 text-center">
                                                <figure class="avatar border-0">
                                                    <span class="avatar-title bg-muted text-white rounded-circle">
                                                        <i class="width-20 height-20" data-feather="plus"></i>
                                                    </span>
                                                </figure>
                                                <div class="mt-2">{{__('Add')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                    ...
                    {{-- <li class="nav-item dropdown d-none d-md-block">
                        <a href="#" class="nav-link" title="Actions" data-toggle="dropdown">{{__('Create')}}</a>
                        <div class="dropdown-menu">
                            <a href="#" class="dropdown-item">{{__('Add Products')}}</a>
                            <a href="#" class="dropdown-item">{{__('Add Category')}}</a>
                            <a href="#" class="dropdown-item">{{__('Add Report')}}</a>
                            <div class="dropdown-divider"></div>
                            <a href="#" class="dropdown-item">{{__('Reports')}}</a>
                            <a href="#" class="dropdown-item">{{__('Customers')}}</a>
                        </div>
                    </li> --}}
                </ul>
            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            <div class="border-bottom px-4 py-3 text-center d-flex justify-content-between align-items-center">
                                ...
                                <small class="opacity-7">{{__('2 unread notifications')}}</small>
                            </div>
                            <div class="dropdown-scroll">
                                <ul class="list-group list-group-flush">
                                    <li class="px-4 py-2 text-center small text-muted bg-light">{{__('Today')}}</li>
                                    ...
                                    <li class="px-4 py-3 list-group-item">
                                        <a href="#" class="d-flex align-items-center hide-show-toggler">
                                            ...
                                            <div class="flex-grow-1">
                                                <p class="mb-0 line-height-20 d-flex justify-content-between">
                                                   {{__('Storage is running low!')}}
                                                    <i title="Mark as read" data-toggle="tooltip" class="hide-show-toggler-item fa fa-circle-o font-size-11"></i>
                                                </p>
                                                <span class="text-muted small">{{__('45 sec ago')}}</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="px-4 py-2 text-center small text-muted bg-light">{{__('Old Notifications')}}</li>
                                    <li class="px-4 py-3 list-group-item">
                                        <a href="#" class="d-flex align-items-center hide-show-toggler">
                                            <div class="flex-shrink-0">
                                                <figure class="avatar mr-3">
                                    ...
                                    <li class="px-4 py-3 list-group-item">
                                        <a href="#" class="d-flex align-items-center hide-show-toggler">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span class="text-muted small">{{__('Last Week')}}</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                    ...
                    {{-- <li class="nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            <div class="border-bottom px-4 py-3 text-center d-flex justify-content-between align-items-center">
                                ...
                                <small class="opacity-7">{{__('4 products')}}</small>
                            </div>
                            <div class="dropdown-scroll">
