...
@section('content')
    <div class="page-header">
        <div>
            <h3>{{ __('Bank Account Type List') }}</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Bank Account Type') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('accounting:js/masters/bankAccountType.js') }}"></script>
@endsection
