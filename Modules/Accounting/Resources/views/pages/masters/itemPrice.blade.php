        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Item Price') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('accounting:js/masters/itemPrice.js') }}"></script>
@endsection
