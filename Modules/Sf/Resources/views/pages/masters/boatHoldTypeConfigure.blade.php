...
@php $title= "New Boat Hold Type" @endphp
...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/sf/boatHoldType_list">{{ __('Boat Hold Types List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New Boat Hold Type') }}</h6>
                    <form id="frmboatHoldTypeConfigure" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom02">{{ __('Hold Type Name*') }}</label>
                                <input type="text" class="form-control" name="HoldTypeName" id="HoldTypeName"
                                    placeholder="Eg : Licence Issue">
                            </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/boatHoldTypeConfigure.js') }}"></script>
@endsection
