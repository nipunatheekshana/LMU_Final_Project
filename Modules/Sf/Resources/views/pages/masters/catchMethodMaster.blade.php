...
@php $title= "Catch Methods List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablecatchMethodMaster"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thCatchMethodCode"> {{ __('Catch Method Code') }}</th>
                                    <th class="thCatchMethodName">{{ __('Catch Method Name') }}</th>
                                    <th class="index"> {{ __('Index') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/catchMethodMaster.js') }}"></script>
@endsection
