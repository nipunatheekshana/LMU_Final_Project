...
@php $title= "Product Quality List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableproductQuality" class="table table-striped table-bordered dataTable dtr-inline collapsed"
                            role="grid" aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thproductQuality">{{ __('Product Quality') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/productQuality.js') }}"></script>
