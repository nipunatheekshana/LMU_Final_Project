...
@php $title= "Cutting Type List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablecuttingtypeMaster"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thCutTypeCode"> {{ __('Cutting Type Code') }}</th>
                                    <th class="thCutTypeName">{{ __('Cutting Type Name') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/cuttingtypeMaster.js') }}"></script>
@endsection
