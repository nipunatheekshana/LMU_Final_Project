...
@php $title= "Fish Species List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablefishSpeciesMaster"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thFishCode"> {{ __('Fish Code') }}</th>
                                    <th class="thFishName">{{ __('Fish Name') }}</th>
                                    <th class="thShortName"> {{ __('Short Name') }}</th>
                                    <th class="thScName "> {{ __('Scientific Name') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/fishSpeciesMaster.js') }}"></script>
@endsection
