...
@php $title= "Company Boat List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/companyBoats.js') }}"></script>
@endsection
