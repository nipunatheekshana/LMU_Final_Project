...
@php $title= "Catch Area List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablecatchAreaMaster"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thAreaCode"> {{ __('Catch area Code') }}</th>
                                    <th class="thAreaName">{{ __('Catch area Name') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/catchAreaMaster.js') }}"></script>
@endsection
