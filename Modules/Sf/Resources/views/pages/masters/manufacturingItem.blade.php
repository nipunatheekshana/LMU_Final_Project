...
@php $title= "Manufacturing Items List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablemanufacturingItem"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thItem_Code">{{ __('Product Code') }}</th>
                                    <th class="thmanufacturingItem">{{ __('Manufacturing Item') }}</th>
                                    <th class="thavg_weight_per_unit">{{ __('Average Weight') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/manufacturingItem.js') }}"></script>
@endsection
