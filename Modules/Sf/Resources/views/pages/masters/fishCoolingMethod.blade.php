...
@php $title= "Fish Cooling Methods List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/fishCoolingMethod.js') }}"></script>
@endsection
