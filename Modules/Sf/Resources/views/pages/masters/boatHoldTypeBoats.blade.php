...
@php $title= "Boat Hold Types List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/boatHoldType.js') }}"></script>
@endsection
