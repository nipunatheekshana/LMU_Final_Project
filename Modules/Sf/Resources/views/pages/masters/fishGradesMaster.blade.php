...
@php $title= "Fish Grades List" @endphp
                        ...
                        <table id="tableFishGradeMaster"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="thQgrade"> {{ __('Quality Grade') }}</th>
                                    <th class="thSgrade">{{ __('Pay Grade') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/fishGradesMaster.js') }}"></script>
@endsection
