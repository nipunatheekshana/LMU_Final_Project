...
@php $title= "New Catch Area" @endphp
...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/sf/catchAreaMaster_list">{{ __('Catch Area List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup Catch Area') }}</h6>
                    <form id="frmcatchAreaMaster" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Catch Area Code*') }}</label>
                                <input type="text" class="form-control" name="AreaCode" id="AreaCode">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom02">{{ __('Catch Area Name*') }}</label>
                                <input type="email" class="form-control" name="AreaName" id="AreaName" required="">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/catchAreaMasterConfigure.js') }}"></script>
@endsection
