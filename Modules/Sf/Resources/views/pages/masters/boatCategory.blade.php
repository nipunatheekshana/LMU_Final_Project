...
@php $title= "Boat Category List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/boatCategory.js') }}"></script>
@endsection
