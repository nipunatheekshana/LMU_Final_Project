...
@php $title= "Reject Reason List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableRejectReasonMaster"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    {{-- <th class="thId">#</th> --}}
                                    <th class="thRejectCode"> {{ __('Reject Reason Code') }}</th>
                                    <th class="thRejectReason">{{ __('Reject Reason Name') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/fishRejectReason.js') }}"></script>
@endsection
