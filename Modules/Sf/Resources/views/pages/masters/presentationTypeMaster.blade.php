...
@php $title= "Presentation Types List" @endphp
                        ...
                        <table id="tablepresentationTypeMaster"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="thPrsntName">{{ __('Present Type Name') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/presentationTypeMaster.js') }}"></script>
@endsection
