...
@php $title= "Byproduct Items List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablebyproductItem"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thbyproductItem">{{ __('Byproduct Item Code') }}</th>
                                    <th class="thbyproductItem">{{ __('Byproduct Item') }}</th>
                                    <th class="thbyproductItem">{{ __('Fish Species') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/byproductItem.js') }}"></script>
@endsection
