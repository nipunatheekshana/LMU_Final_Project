...
@php $title= "Sea Food Raw Material List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableseaFoodRawMaterial"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thseaFoodRawMaterial">{{ __('SeaFood Raw Material') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/seaFoodRawMaterial.js') }}"></script>
@endsection
