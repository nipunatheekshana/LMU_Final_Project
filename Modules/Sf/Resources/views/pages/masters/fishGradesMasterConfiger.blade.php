...
@php $title= "New Fish Grade" @endphp
...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/sf/fishGradesMaster_list">{{ __('Fish Grades List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup Fish Grade') }}</h6>
                    <form id="frmFishGradeMaster" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Quality Grade*') }}</label>
                                <input type="text" class="form-control" name="QualityFishGrade" id="QualityFishGrade">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom02">{{ __('Pay Fish Grade*') }}</label>
                                <input type="email" class="form-control" name="PayFishGrade" id="PayFishGrade"
                                    required="">
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="HNG_GRADE" name="HNG_GRADE">
                                    <label class="form-check-label" for="exampleCheck1">{{ __('HNG GRADE') }}</label>
                                </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/fishGradesMasterConfiger.js') }}"></script>
@endsection
