...
@php $title= "New Company Boat" @endphp
...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/sf/companyBoats_list">{{ __('Company Boats List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New Company Boat') }}</h6>
                    <form id="frmcompanyBoatsConfigure" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Boat*') }}</label>
                                <select class="form-control" name="BoatId" id="BoatId">
                                    <option value="">-Select-</option>
                                </select>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom02">{{ __('Hold Comment') }}</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">{{ __('On Hold') }}</label>
                                </div>
                                <div class="form-group form-check">
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/companyBoatsConfigure.js') }}"></script>
@endsection
