...
@php $title= "Landing Sites List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablelandingsiteMaster"
                        class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                        aria-describedby="example1_info">
                        <thead>
                            <tr>
                                <th class="thId">#</th>
                                <th class="thLandingSiteName">{{ __('Landing Site Name') }}</th>
                                <th class="thLatLong">{{ __('Latitude + Longitude') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('sf:js/masters/landingsiteMaster.js') }}"></script>
@endsection
