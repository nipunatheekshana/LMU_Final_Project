...
@php $title= "Suppliers List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablesupplier" class="table table-striped table-bordered dataTable dtr-inline collapsed"
...
@section('script')
    ...
    <script src="{{ Module::asset('buying:js/masters/supplier.js') }}"></script>
@endsection
