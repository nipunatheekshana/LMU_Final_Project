...
@php $title= "Supplier Groups List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('buying:js/masters/supplierGroup.js') }}"></script>
@endsection
