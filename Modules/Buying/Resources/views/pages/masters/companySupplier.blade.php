...
@php $title= "Company Suppliers List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('buying:js/masters/companySupplier.js') }}"></script>
@endsection
