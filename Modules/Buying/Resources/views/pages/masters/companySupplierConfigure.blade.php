...
@php $title= "New Company Supplier" @endphp
...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/buying/companySupplier_list">{{ __('Company Supplier List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New Company Supplier') }}</h6>
                    <form id="frmcompanySupplierConfigure" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Hold Comment') }}</label>
                                <input type="text" class="form-control" name="hold_Comment" id="hold_Comment">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group form-check">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">{{ __('on_hold') }}</label>
                                </div>
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="is_sf_supplier"
                                        name="is_sf_supplier">
                                    <label class="form-check-label" for="exampleCheck1">{{ __('is_sf_supplier') }}</label>
                                </div>
                                <div class="form-group form-check">
...
@section('script')
    ...
    <script src="{{ Module::asset('buying:js/masters/companySupplierConfigure.js') }}"></script>
@endsection
