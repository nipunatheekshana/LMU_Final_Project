...
@php $title= "Supplier Hold Types List" @endphp
...
@section('script')
    ...
    <script src="{{ Module::asset('buying:js/masters/supplierHoldTypes.js') }}"></script>
@endsection
