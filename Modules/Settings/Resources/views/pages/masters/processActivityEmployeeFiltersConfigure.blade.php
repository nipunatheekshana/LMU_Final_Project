...
@section('title', 'New Process Activity Employee Filter')
@section('head')
    <!-- DataTable -->
...
@section('content')
    <div class="page-header">
        <div>
            <h3>{{ __('New Process Activity Employee Filter') }}</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#">{{ __('Process Activity Employee Filter') }}</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('New Process Activity Employee Filter') }}
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New Process Activity Employee Filter') }}</h6>
                    <form id="frmprocessActivityEmployeeFiltersConfigure" autocomplete="off">
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/processActivityEmployeeFiltersConfigure.js') }}"></script>
@endsection
