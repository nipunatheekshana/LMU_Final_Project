...
@section('title','Barcode Type List')
@section('head')
    <!-- DataTable -->
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Barcode Type') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/barcodeTypes.js') }}"></script>
@endsection
