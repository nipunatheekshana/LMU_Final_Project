...
@section('title','Process Workstation List')
@section('head')
    <!-- DataTable -->
...
@section('content')
    <div class="page-header">
        <div>
            <h3>{{ __('Process Workstation List') }}</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Process Workstation') }}</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableprocessWorkstation"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thprocessWorkstation">{{ __('Process | Workstation') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/processWorkstation.js') }}"></script>
@endsection
