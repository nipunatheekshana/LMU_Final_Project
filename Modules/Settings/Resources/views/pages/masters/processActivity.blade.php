...
@section('title','Process Activity List')
@section('head')
    <!-- DataTable -->
...
@section('content')
    <div class="page-header">
        <div>
            <h3>{{ __('Process Activity List') }}</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Process Activity') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/processActivity.js') }}"></script>
@endsection
