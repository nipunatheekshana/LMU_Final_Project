        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="#">{{ __('Data Type') }}</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Data Type') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/dataType.js') }}"></script>
@endsection
