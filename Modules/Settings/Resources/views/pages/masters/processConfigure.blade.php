...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('New Process') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New Process') }}</h6>
                    <form id="frmprocessConfigure" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Process Name') }}</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label for="validationCustom01">{{ __('Process Description') }}</label>
                                <textarea type="text" class="form-control" name="ProcessDescription" id="ProcessDescription"></textarea>
                            </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/processConfigure.js') }}"></script>
@endsection
