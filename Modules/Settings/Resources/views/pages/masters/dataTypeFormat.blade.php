...
@section('content')
    <div class="page-header">
        <div>
            <h3>{{ __('Data Type Format List') }}</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Data Type Format') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/dataTypeFormat.js') }}"></script>
@endsection
