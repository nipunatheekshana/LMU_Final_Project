                    ...
                    <div class="table-responsive">
                        <table id="tablereport"
                            ...
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="threport_name">{{ __('Report Name') }}</th>
                                    <th class="thremodule">{{ __('Module') }}</th>
                                    <th class="threport_file_location">{{ __('File Location') }}</th>
                                    <th class="threport_level">{{ __('Report Level') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('settings:js/masters/report.js') }}"></script>
@endsection
