...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('settings_process_activity_employee_filters', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('EmpID')->references('id')->on('hrm_employees')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('settings_process_activity_employee_filters');
    }
};
