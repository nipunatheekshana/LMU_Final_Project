            ...
            <div class="header-body-left">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown d-none d-md-block">
                        <a href="#" class="nav-link" title="Apps" data-toggle="dropdown">{{__('Apps')}}</a>
                        <div class="dropdown-menu dropdown-menu-big">
                            <div class="border-bottom px-4 py-3 text-center d-flex justify-content-between">
                                <h5 class="mb-0">{{__('Apps')}}</h5>
                            </div>
                            <div class="p-3">
                                    ...
                                    <div class="col-6">
                                        <a href="#">
                                            <div class="border-radius-1 text-center">
                                                ...
                                                <div class="mt-2">{{__('Todo List')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-6">
                                        <a href="#">
                                            <div class="border-radius-1 text-center">
                                                ...
                                                <div class="mt-2">{{__('File Manager')}}</div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
