...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('New address') }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Create New Address') }}</h6>
                    <form id="frmaddressConfigure" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Address Title') }}</label>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="PreferedBillingAddress"
                                        name="PreferedBillingAddress">
                                    <label class="form-check-label"
                                        for="exampleCheck1">{{ __('Billing Address') }}</label>
                                </div>

                                <div class="form-group form-check">
                                    <input type="checkbox" class="form-check-input" id="PreferedShippingAddress"
                                        name="PreferedShippingAddress">
                                    <label class="form-check-label"
                                        for="exampleCheck1">{{ __('Shipping Address') }}</label>
                                </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('crm:js/masters/addresConfigure.js') }}"></script>
@endsection
