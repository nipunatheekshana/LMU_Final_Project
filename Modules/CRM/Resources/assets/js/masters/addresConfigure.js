console.log('addressConfigure.js loadimng');
var parent_url = '/crm/address_list';
...
function update(data) {
    $.ajax({
        type: "POST",
        url: "/crm/addressConfigure/update",
        data: data,
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
...
function loadCountries() {
    $.ajax({
        type: 'GET',
        url: '/crm/addressConfigure/loadCountries',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
...
function loadAddressType() {
    $.ajax({
        type: 'GET',
        url: '/crm/addressConfigure/loadAddressType',
        async: false,
        success: function (response) {
            console.log(response)
            if (response.success) {
...
function loadAddress() {
    ...
    if (id) {
        $.ajax({
            type: "GET",
            url: "/crm/addressConfigure/loadAddress/" + id,
            processData: false,
            contentType: false,
            cache: false,
            timeout: 800000,
