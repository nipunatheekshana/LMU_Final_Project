...
@php $title= "Item Alternatives List" @endphp
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <button id="btnCreateNew" class="btn btn-primary mb-3" style="float: right" type="button">New Alternative Item</button>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <table id="tableitemAlternative"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="thitemAlternative">{{ __('Item Alternative') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/itemAlternative.js') }}"></script>
@endsection
