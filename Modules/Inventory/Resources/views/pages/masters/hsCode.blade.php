...
@php $title= "HS Codes List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablehsCode"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thhsCode">{{ __('HS Code') }}</th>
                                    <th class="thCounthDescriptiontry">{{ __('Country') }}</th>
                                    <th class="">{{ __('Discription') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/hsCode.js') }}"></script>
@endsection
