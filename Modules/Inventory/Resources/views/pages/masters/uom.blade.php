            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableuom" class="table table-striped table-bordered dataTable dtr-inline collapsed"
                            role="grid" aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thuom">{{ __('Unit Of Measurement') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/uom.js') }}"></script>
@endsection
