...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/inventory/hsCode_list">{{ __('HS Code List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New HS Code') }}</h6>
                    <form id="frmhsCodeConfigure" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('HS Code*') }}</label>
                                <input type="text" class="form-control" name="HSCode" id="HSCode"
                                    placeholder="Eg : 0304.41.00">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="validationCustom01">{{ __('HS Code Description') }}</label>
                                <textarea type="text" class="form-control" name="HS_Description" id="HS_Description"
                                    placeholder="Eg : Pacific salmon (Oncorhynchus nerka)"></textarea>
                            </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/hsCodeConfigure.js') }}"></script>
@endsection
