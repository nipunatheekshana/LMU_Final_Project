...
@section('title','Delivery Note List')
@section('head')
    <!-- DataTable -->
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Delivery Note') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/deliveryNote.js') }}"></script>
@endsection
