        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Warehouse Type') }}</li>
                </ol>
            </nav>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/warehouseType.js') }}"></script>
@endsection
