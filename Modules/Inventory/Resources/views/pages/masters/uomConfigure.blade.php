...
@section('content')
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="/inventory/uom_list">{{ __('UOM List') }}</a>
                    </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ __('Setup New Unit Of Measurement') }}</h6>
                    <form id="frmuomConfigure" autocomplete="off">

                        <input type="hidden" id="hiddenId" name="id">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">{{ __('Unit Of Measurement Name*') }}</label>
                                <input type="text" class="form-control" name="UomName" id="UomName"
                                    placeholder="Eg : kg">
                            </div>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/uomConfigure.js') }}"></script>
@endsection
