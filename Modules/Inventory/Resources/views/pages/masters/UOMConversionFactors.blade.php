...
@php $title= "UOM Conversion Factors List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tableUOMConversionFactors"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thFromUOM">{{ __('From') }}</th>
                                    <th class="thToUOM">{{ __('To') }}</th>
                                    <th class="thFactor">{{ __('Factor') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('inventory:js/masters/UOMConversionFactors.js') }}"></script>
@endsection
