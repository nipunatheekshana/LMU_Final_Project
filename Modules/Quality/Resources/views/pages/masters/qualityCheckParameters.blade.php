...
@php $title= "Quality Checking Parameters List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablequalityCheckParameter"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thqualityCheckParameter">{{ __('Quality Check Parameter') }}</th>
                                    <th class="thMinValue">{{ __('Minimum Value') }}</th>
                                    <th class="thMaxValue">{{ __('Maximum Value') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('quality:js/masters/qualityCheckParameters.js') }}"></script>
@endsection
