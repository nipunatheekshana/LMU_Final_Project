...
@php $title= "Lab Test Types List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablelabTestTypes"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thlabTestTypeCode">{{ __('Type Code') }}</th>
                                    <th class="thlabTestTypeName">{{ __('Type Name') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('quality:js/masters/labTestTypes.js') }}"></script>
@endsection
