...
@php $title= "Quality Checking Rules List" @endphp
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tablequalityCheckingRules"
                            class="table table-striped table-bordered dataTable dtr-inline collapsed" role="grid"
                            aria-describedby="example1_info">
                            <thead>
                                <tr>
                                    <th class="thId">#</th>
                                    <th class="thqualityCheckingRules">{{ __('Quality Checking Rule') }}</th>
...
@section('script')
    ...
    <script src="{{ Module::asset('quality:js/masters/qualityCheckingRules.js') }}"></script>
@endsection
