...
Date: 2022-05-17 07:52:27
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for tabSupplierContact
-- ----------------------------
DROP TABLE IF EXISTS `tabSupplierContact`;
CREATE TABLE `tabSupplierContact` (
  `SupID` varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ContactID` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`SupID`,`ContactID`)
